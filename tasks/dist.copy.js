...
module.exports = function(gulp) {
  return function() {
    ...
    var extraDirectories = [
      ...
      'public/bower_components/px-spinner',
    ...
    var JSFiles = gulp.src(['public/js/**/*.*']).pipe(gulp.dest(outputDir + 'public/js'));
    return merge(server, packageFile, extraStreams, docsFiles, imageFiles,JSFiles);
  };
};
